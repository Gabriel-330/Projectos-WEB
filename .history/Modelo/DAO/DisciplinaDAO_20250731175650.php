...
class DisciplinaDAO
{
    ...
    {
        try {
            $sql = "UPDATE disciplina SET nomeDisciplina = :nome,classeDisciplina, idCurso = :idCurso, idProfessor =: idProfessor WHERE idDisciplina = :id";
