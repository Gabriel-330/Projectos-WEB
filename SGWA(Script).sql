...
CREATE TABLE IF NOT EXISTS `SGWA`.`documento` (
  ...
  `tipoDocumento` ENUM('Declaração', 'Boletim', 'Certificado', 'Mini Pauta') NOT NULL,
  `estadoDocumento` ENUM('Aceite', 'Recusado', 'Validado', 'Em validação') NULL,
  `dataEmissaoDocumento` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `cursoDocumento` VARCHAR(45) NULL,
  `turmaDocumento` VARCHAR(45) NULL,
  `classeDocumento` VARCHAR(45) NULL,
  `periodoDocumento` VARCHAR(45) NULL,
  `disciplinaDocumento` VARCHAR(45) NULL,
  PRIMARY KEY (`idDocumento`),
  INDEX `fk_documento_aluno1_idx` (`idAluno` ASC) VISIBLE,
  INDEX `fk_documento_professor1_idx` (`idProfessor` ASC) VISIBLE,
  CONSTRAINT `fk_documento_aluno1`
    FOREIGN KEY (`idAluno`)
    REFERENCES `SGWA`.`aluno` (`idAluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_documento_professor1`
    FOREIGN KEY (`idProfessor`)
    REFERENCES `SGWA`.`professor` (`idProfessor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `SGWA`.`evento` (
  ...
  `tipoEvento` ENUM('Prova', 'Actividade', 'Reunião', 'Apresentação') NOT NULL,
  `idUtilizador` INT NOT NULL,
  `idCurso` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `SGWA`.`pautaResumo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SGWA`.`pautaResumo` (
  `idpautaResumo` INT NOT NULL AUTO_INCREMENT,
  `notaPauta` VARCHAR(45) NULL,
  `disciplinaPauta` VARCHAR(45) NULL,
  `idAluno` INT NOT NULL,
  `idCurso` INT NOT NULL,
  PRIMARY KEY (`idpautaResumo`),
  INDEX `fk_pautaResumo_aluno1_idx` (`idAluno` ASC) VISIBLE,
  INDEX `fk_pautaResumo_curso1_idx` (`idCurso` ASC) VISIBLE,
  CONSTRAINT `fk_pautaResumo_aluno1`
    FOREIGN KEY (`idAluno`)
    REFERENCES `SGWA`.`aluno` (`idAluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pautaResumo_curso1`
    FOREIGN KEY (`idCurso`)
    REFERENCES `SGWA`.`curso` (`idCurso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
