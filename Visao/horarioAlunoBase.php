        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li class="active"><a href="#" title="Consultar Horário"><i class="fa-regular fa-calendar"></i><span class="text-white">Horários</span></a></li>
    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="page-titles">
                <h4>Consultar Horário</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Alunos</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Horário</a></li>
                </ol>
            </div>
            ...
            <form action="horarioAlunoBase.php" method="GET">
                <div class="col-md-5">
                    <div class="form-group d-flex">
                        <input type="text"
                            class="form-control input-rounded flex-grow-1 me-2"
                            style="width: 200px;"
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item btn-apagar-horario" data-bs-toggle="modal" data-bs-target="#modalHorarioApagar" data-id="<?= $horario->getIdHorario() ?>">
                                                                    <i class="fa fa-trash me-2 text-danger"></i> Apagar
                                                                </a>
                                                                <a class="dropdown-item btn-editar-horario" data-bs-toggle="modal" data-bs-target="#modalHorarioEditar" data-id="<?= $horario->getIdHorario() ?>">
