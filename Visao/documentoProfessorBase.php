...
<body onload="initProgressBars()">
    ...
    <div class="content-body">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <?php if ($documento->getEstadoDocumento() === "Aceite") : ?>
                                                                    <?php
                                                                    $linkVisualizar = "#";
                                                                    if ($documento->getTipoDocumento() === "Boletim") {
                                                                        $linkVisualizar = "boletim.php?id=" . $documento->getIdDocumento();
                                                                    } elseif ($documento->getTipoDocumento() === "Mini Pauta") {
                                                                        $linkVisualizar = "minipauta.php?id=" . $documento->getIdDocumento();
                                                                    }
                                                                    ?>
                                                                    <a class="dropdown-item btn-visualizar-documento"
                                                                        href="<?= $linkVisualizar ?>"
                                                                        target="_blank">
                                                                        <i class="fa fa-eye me-2 text-info"></i> Visualizar
                                                                    </a>

                                                                <?php elseif ($documento->getEstadoDocumento() === "Validado") : ?>
                                                                    <?php if ($documento->getTipoDocumento() !== "Mini Pauta") : ?>
                                                                        <!-- Mostrar apenas Apagar -->
                                                                        <a class="dropdown-item btn-apagar-documento"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#modalDocumentoApagar"
                                                                            data-id="<?= $documento->getIdDocumento() ?>">
                                                                            <i class="fa fa-trash-alt me-2 text-danger"></i> Cancelar
                                                                        </a>
                                                                    <?php else : ?>
                                                                        <!-- Mostrar Editar e Apagar -->
                                                                        <a class="dropdown-item btn-editar-documento"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#modalDocumentoEditar"
                                                                            data-id="<?= $documento->getIdDocumento() ?>">
                                                                            <i class="fa fa-pencil-alt me-2 text-warning"></i> Editar
                                                                        </a>
                                                                        <a class="dropdown-item btn-apagar-documento"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#modalDocumentoApagar"
                                                                ...
                                                                <?php elseif ($documento->getEstadoDocumento() === "Em validação") : ?>
                                                                    <a class="dropdown-item btn-recusar-documento"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#modalDocumentoRecusar"
                                                                        data-id="<?= $documento->getIdDocumento() ?>">
                                                                        <i class="fa fa-times-circle me-2 text-danger"></i> Recusar
                                                                    </a>
                                                                    <a class="dropdown-item btn-validar-documento"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#modalDocumentoValidar"
                                                                        data-id="<?= $documento->getIdDocumento() ?>">
                                                                        <i class="fa fa-check-circle me-2 text-success"></i> Validar
                                                                    </a>
                                                                <?php endif; ?>
                                                            </div>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="4" class="text-center text-muted">
                                                    <i class="fa fa-info-circle me-2"></i> Nenhum documento solicitado.
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
        ...
        <div class="modal fade" id="modalDocumentoEditar">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="../Controle/crudDocumento.php" method="POST">
                            <input type="hidden" name="estadoDocumento" value="Validado">
                            <input type="hidden" name="idAluno" value="">
                            <input type="hidden" name="idDocumento" id="idDocumentoEditar">

                            <div class="col-md-12">
                                <label><strong>Tipo de Documento</strong></label>
                                <select id="tipoDocumentoSelect" class="form-control input-rounded" id="tipoDocumentoEditar" name="tipoDocumento" required>
                                    <option value="">Selecione o tipo de Documento</option>
                                    <option value="Mini Pauta">Mini Pauta</option>
                                </select>
                            </div>
                            ...
                            <div class="campo-condicional mt-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label><strong>Curso</strong></label>
                                        <select id="cursoSelect" id="cursoDocumentoEditar" name="cursoDocumento" class="form-control input-rounded" required>
                                            <option value="">Selecione o curso</option>
                                            <?php foreach ($cursos as $curso): ?>
                                                <option value="<?= $curso->getNomeCurso() ?>"><?= htmlspecialchars($curso->getNomeCurso()) ?></option>
                                            <?php endforeach; ?>
                                    ...
                                    <div class="col-md-6">
                                        <label><strong>Disciplina</strong></label>
                                        <select id="disciplinaDocumentoEditar" name="disciplinaDocumento" class="form-control input-rounded" required>
                                            <option value="">Selecione a disciplina</option>
                                            <?php foreach ($disciplinas as $disciplina): ?>
                                                <option value="<?= $disciplina->getNomeDisciplina() ?>"><?= htmlspecialchars($disciplina->getNomeDisciplina()) ?></option>
                                            <?php endforeach; ?>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4">
                                        <label><strong>Classe</strong></label>
                                        <select id="classeDocumentoEditar" class="form-control input-rounded" name="classeDocumento" required>
                                            <option value="">Selecione</option>
                                            <option value="10">10ª</option>
                                            <option value="11">11ª</option>
                                            <option value="12">12ª</option>
                                    ...
                                    <div class="col-md-4">
                                        <label><strong>Período</strong></label>
                                        <select id="periodoDocumentoEditar" class="form-control input-rounded" name="periodoDocumento" required>
                                            <option value="">Selecione</option>
                                            <option value="Manhã">Manhã</option>
                                            <option value="Tarde">Tarde</option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        <label><strong>Turma</strong></label>
                                        <select id="turmaDocumento" class="form-control input-rounded" name="turmaDocumento" required>
                                            <option value="">Selecione a turma</option>
                                            <?php foreach ($turmas as $turma): ?>
                                                <option value="<?= $turma->getNomeTurma() ?>"><?= htmlspecialchars($turma->getNomeTurma()) ?></option>
                                            <?php endforeach; ?>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary btn-rounded" name="actualizarDocumentoProfessor">Salvar Alterações</button>
                                <a href="#" class="btn btn-light btn-rounded ml-2" data-bs-dismiss="modal">Cancelar</a>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="modalDocumentoValidar">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Validar solicitação de documento</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <p>Tem certeza que deseja Validar esta solicitação de Documento? Esta ação não pode ser desfeita.</p>
                        <form id="formDocumentoValidar" method="POST" action="../Controle/validarDocumento.php">
                            <input type="hidden" name="idDocumento" id="idDocumentoValidar" required>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <a href="#" class="btn btn-light btn-rounded ml-2" data-bs-dismiss="modal">Cancelar</a>
                        <button type="submit" form="formDocumentoValidar" class="btn btn-primary" name="validarDocumento">Confirmar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).on('click', '.btn-validar-documento', function() {
            const id = $(this).data('id');
            ...
            $.get('../Controle/retornarDocumento.php', {
                ...
                try {
                    ...
                    $('#idDocumentoValidar').val(doc.idDocumento);
