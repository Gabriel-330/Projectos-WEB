        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li class="active"><a href="#" title="Calendário Académico"><i class="fa-regular fa-calendar"></i></a></li>
                    <li><a href="cursoBase.php" title="Cursos"><i class="fa-solid fa-book"></i></a></li>
                    <li><a href="horarioBase.php" title="Horários"><i class="fa-solid fa-clock"></i></a></li>
                    <li><a href="turmaBase.php" title="Turmas"><i class="fa-solid fa-users"></i></a></li>
                    <li><a href="disciplinaBase.php" title="Disciplinas"><i class="fa-solid fa-book-open"></i></a></li>
    ...
    <div class="content-body" style="margin-top: -30px;">
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <h4>Gestão de Evento</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Administração</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Gestão de Evento</a></li>
                </ol>
            </div>
            <!-- row -->
            ...
            if ($palavra) {
                ...
                // Caso contrário, exibir todos os eventos
                $cursos = $dao->listarTodos();
            }
            ?>
            <!-- Formulário de pesquisa -->
            <form action="eventoBase.php" method="GET">
                <div class="col-md-12">
                    <div class="form-group d-flex align-items-center">
                        <input
                            type="text"
                            class="form-control input-rounded me-2"
                            style="max-width: 300px;"
                            placeholder="Pesquisar evento..."
                            name="palavra"
                            value="<?= htmlspecialchars($palavra) ?>">
