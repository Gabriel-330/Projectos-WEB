...
<body onload="initProgressBars()">
        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li><a href="notaProfessorBase.php" title="Lançar Nota"><i class="fa-solid fa-clipboard"></i><span>Notas</span></a></li>
    ...
    <div class="content-body" style="margin-top: -30px;">
        ...
        <div class="container-fluid">
            ...
            $totalDisciplinas = $disciplinaDAO->contarTodas();
            $totalTurmas = $turmaDAO->contarTodas();

            $totalDisciplinas = is_numeric($totalDisciplinas) ? $totalDisciplinas : 0;
            $totalTurmas = is_numeric($totalTurmas) ? $totalTurmas : 0;

            $totalGeral = $totalDisciplinas + $totalTurmas;
            ...
            <section class="cards">
                <div class="card-1">
                    ...
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?= percentagemEscala($totalDisciplinas, $maxDisciplinas) ?>%;"></div>
                    </div>
                </div>

                <div class="card-2">
                    <p>Turmas <i class="fa-solid fa-users card-icon"></i></p>
                    <h2><?= $totalTurmas ?></h2>
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?= percentagemEscala($totalTurmas, $maxTurmas) ?>%;"></div>
                    </div>
                </div>
            </section>
