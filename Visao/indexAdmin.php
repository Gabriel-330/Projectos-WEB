    ...
    <div class="header">
        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    <li><a href="#" title="Home" id="linkAdicionarAluno"><i class="fa-solid fa-chalkboard"></i></a></li>
                    ...
                    <li><a href="eventoBase.php" title="Cadastro de Evento"><i class="fa-regular fa-calendar"></i></a></li>
