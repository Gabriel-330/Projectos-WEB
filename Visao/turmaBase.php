        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li class="active"><a href="#" title="Cadastro de Turmas"><i class="fa-solid fa-users"></i><span>Turma</span></a></li>
                    <li><a href="disciplinaBase.php" title="Cadastro de Disciplinas"><i class="fa-solid fa-book-open"></i><span>Disciplina</span></a></li>
        ...
        <div class="container-fluid">
            <div class="page-titles">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Gestão de Turmas</a></li>
                </ol>
            </div>
            <!-- row -->
            <?php
            ...
            if ($palavra) {
                ...
                $turmas = $dao->pesquisarTurma($palavra);
            } else {
                // Caso contrário, exibir todos os turmas
            ...
            <form action="horarioBase.php" method="GET">
                <div class="col-md-5">
                    <div class="form-group d-flex">
                        <input type="text" class="form-control input-rounded flex-grow-1 me-2" style="width: 200px;" placeholder="Pesquisar turmas..." name="palavra" value="<?= htmlspecialchars($palavra) ?>">
