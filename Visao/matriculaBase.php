...
//<td><span class="badge light badge-warning">TRANCADA</span></td>
?>
...
<body onload="initProgressBars()">
        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li><a href="eventoBase.php" title="Calendário Académico"><i class="fa-regular fa-calendar"></i><span>Evento</span></a></li>
                    <li><a href="cursoBase.php" title="Cadastro de Cursos"><i class="fa-solid fa-book"></i><span>Curso</span></a></li>
                    <li><a href="horarioBase.php" title="Cadastro de Horários"><i class="fa-solid fa-clock"></i><span>Horário</span></a></li>
                    ...
                    <li class="active"><a href="#" title="Matrícula"><i class="fa-solid fa-file-signature"></i><span>Matrícula</span></a></li>
                </ul>
            </div>
        </nav>
    </div>
    ...
    <div class="content-body" style="margin-top: -30px;">
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <h4>Gestão de Matriculas</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Administração</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Gestão de Matricula</a></li>
                </ol>
            </div>
            <!-- row -->
            ...
            if ($palavra) {
                ...
                $matriculas = $dao->pesquisarMatriculas($palavra);
            } else {
                // Caso contrário, exibir todos os matriculas
                $matriculas = $dao->listarTodasMatriculas();
            }
            ?>

            <form action="../Controle/crudMatricula.php" method="GET">
                <div class="col-md-5">
                    <div class="form-group d-flex">
                        <input type="text" class="form-control input-rounded flex-grow-1 me-2" style="width: 200px;" placeholder="Pesquisar matricula..." name="palavra" value="<?= htmlspecialchars($palavra) ?>">
                                ...
                                <table class="table table-responsive-md text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><strong>DATA DE MATRICULA</strong></th>
                                            <th><strong>ESTADO DA MATRICULA</strong></th>
        ...
        <div class="modal fade" id="modalMatriculaCadastrar">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Cadastrar Matricula</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <form action="../Controle/crudMatricula.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input-rounded" name="turmaMatricula" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-rounded" name="cursoMatricula" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-rounded" name="alunoMatricula" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-rounded" name="estadoMatricula" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control input-rounded" name="dataMatricula" required>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modalMatriculaEditar">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="../Controle/crudMatricula.php" method="POST">
                            <input type="hidden" name="idMatricula" id="idMatriculaEditar" required>
                            <?php
                            require_once("../Modelo/DAO/CursoDAO.php");
                            require_once("../Modelo/DAO/TurmaDAO.php");
                            require_once("../Modelo/DAO/AlunoDAO.php");
        ...
        <div class="modal fade" id="modalMatriculaApagar">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Tem certeza que deseja excluir os dados desta Matricula? Esta ação não pode ser desfeita.</p>
                        <form id="formMatriculaExcluir" method="POST" action="../Controle/crudMatricula.php">
                            <input type="hidden" name="idMatricula" id="idMatriculaApagar" required>
                        </form>
                    </div>
    ...
    <script>
        $(document).on('click', '.btn-editar-matricula', function() {
            ...
            $.get('../Controle/retornarMatricula.php', {
                id: id
            }, function(data) {
                try {
    ...
    <script>
        $(document).on('click', '.btn-apagar-matricula', function() {
            ...
            $.get('../Controle/retornarMatricula.php', {
                ...
                try {
                    const Matricula = data;
                    $('#idMatriculaApagar').val(Matricula.idMatricula);
