...
<body onload="initProgressBars()">
        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li class="active"><a href="#" title="Cadastro de Cursos"><i class="fa-solid fa-book"></i><span class="text-white">Cursos</span></a></li>
    ...
    <div class="content-body" style="margin-top: -30px;">
        ...
        <div class="modal fade" id="modalCursoEditar">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="modalCursoApagar">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Tem certeza que deseja excluir os dados deste Curso? Esta ação não pode ser desfeita.</p>
                        <form id="formCursoExcluir" method="POST" action="../Controle/crudCurso.php">
                            <input type="hidden" name="idCurso" id="idCursoApagar" required>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" form="formCursoExcluir" class="btn btn-danger" name="apagarCurso">Confirmar Exclusão</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).on('click', '.btn-editar-curso', function() {
            ...
            $.get('../Controle/retornarCurso.php', {
                id: id
            }, function(data) {
                try {
                    const Curso = data;
                    $('#idCursoEditar').val(Curso.idCurso);
                    $('#nomeCursoEditar').val(Curso.nomeCurso);
    ...
    <script>
        $(document).on('click', '.btn-apagar-curso', function() {
            ...
            $.get('../Controle/retornarCurso.php', {
                ...
                try {
                    const Curso = data;
                    $('#idCursoApagar').val(Curso.idCurso);
