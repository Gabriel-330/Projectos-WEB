        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    ...
                    <li class="active"><a href="#" title="Cadastro de Disciplinas"><i class="fa-solid fa-book-open"></i></a></li>
    ...
    <div class="content-body" style="margin-top: -30px;">
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <h4>Gestão de Disciplina</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Administração</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Gestão de Disciplina</a></li>
                </ol>
            </div>
            <!-- row -->
            ...
            if ($palavra) {
                ...
                $disciplinas = $dao->pesquisar($palavra);
            } else {
                // Caso contrário, exibir todos os disciplinas
                $disciplinas = $dao->listarTodos();
            }
            ?>

            <!-- Formulário de pesquisa -->
            <form action="disciplinaBase.php" method="GET">
                <div class="col-md-5">
                    <div class="form-group d-flex">
                        <input type="text" class="form-control input-rounded flex-grow-1 me-2" style="width: 200px;" placeholder="Pesquisar disciplinas..." name="palavra" value="<?= htmlspecialchars($palavra) ?>">
        ...
        <div class="modal fade" id="modalDisciplinaCadastrar">
                    ...
                    <div class="modal-body">
                        <form action="../Controle/crudDisciplina.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input-rounded" name="cursoDisciplina" required>
