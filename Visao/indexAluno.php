    ...
    <div class="header">
        ...
        <nav class="menu-user">
            <div class="menu-content">
                ...
                <ul>
                    <li class="active"><a href="#" title="Home"><i class="fa-solid fa-chalkboard"></i><span class="text-white">Dashboard</span></a></li>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
                <div class="me-auto">
                    <h2 class="text-black font-w600">Área Aluno</h2>
            ...
            $totalEventos = $eventosDAO->contarTodos();
            $totalNota = $notaDAO->contarTodos();
            $totalDocumentos = $documentoDAO->contarTodos();
            $totalDisciplina = $disciplinaDAO->contarTodas();

            // Se algum retornar false, assume 0 para evitar erros
            $totalEventos = is_numeric($totalEventos) ? $totalEventos : 0;
            $totalNota = is_numeric($totalNota) ? $totalNota : 0;
            $totalDocumentos = is_numeric($totalDocumentos) ? $totalDocumentos : 0;
            $totalDisciplina = is_numeric($totalDisciplina) ? $totalDisciplina : 0;

            $totalGeral = $totalEventos + $totalNota + $totalDocumentos + $totalDisciplina;
            ...
            <section class="cards">
                <div class="card-1">
                    <p>Disciplinas <i class="fa-solid fa-book-open card-icon"></i></p>
                    <h2><?= $totalDisciplina ?></h2>
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?= percentagemEscala($totalDiciplinas, $maxDisciplinas) ?>%;"></div>
                    </div>
                </div>

                <div class="card-2">
                    <p>Documentos Enviados <i class="fa-regular fa-file-lines card-icon"></i></p>
                    <h2><?= $totalDocumentos ?></h2>
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?= percentagemEscala($totalDocumentos, $maxDocumento) ?>%;"></div>
                    </div>
                </div>

                <div class="card-3">
                    <p>Eventos Académicos <i class="fa-solid fa-calendar-days card-icon"></i></p>
                    <h2><?= $totalEventos ?></h2>
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?= percentagemEscala($totalEventos, $maxEvento) ?>%;"></div>
                    </div>
                </div>

                <div class="card-4">
                    <p>Notas Lançadas <i class="fa-solid fa-clipboard-check card-icon"></i></p>
                    <h2><?= $totalNota ?></h2>
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?= percentagemEscala($totalNota, $maxNota) ?>%;"></div>
                    </div>
                </div>
            </section>
