    ...
    <div class="content-body">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <?php if ($documento->getEstadoDocumento() === "Em validação") : ?>
                                                                ...
                                                                <a class="dropdown-item btn-apagar-documento"
                                                                    ...
                                                                    data-id="<?= $documento->getIdDocumento() ?>">
                                                                    <i class="fa fa-trash me-2 text-danger"></i> Cancelar
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="../Controle/crudDocumento.php" method="POST">
                            ...
                            $Professors = $daoProfessor->listarTodos();
                            ?>
                            <div class="col-md-12 mt-3">
                                <label><strong>Director de Turma</strong></label>
                                <select name="idProfessor" class="form-control input-rounded" required>
                                    <option value="">Selecione o director de turma</option>
                                    <?php foreach ($Professors as $Professor): ?>
                                        <option value="<?= $Professor->getIdProfessor() ?>"><?= htmlspecialchars($Professor->getNomeProfessor()) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary btn-rounded" name="solicitarDocumentoAluno">Solicitar</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="../Controle/crudDocumento.php" method="POST">
                            ...
                            <div class="col-md-12">
                                <label><strong>Tipo de Documento</strong></label>
                                <select class="form-control input-rounded" id="tipoDocumentoEditar" name="tipoDocumento">
                                    <option value="">Selecione o tipo de Documento</option>
                                    <option value="Boletim">Boletim</option>
                                    <option value="Certificado">Certificado</option>
                                    <option value="Declaração">Declaração</option>
                            ...
                            <div class="col-md-12 mt-3">
                                <label><strong>Director de Turma</strong></label>
                                <select name="idProfessor" id="idProfessorEditar" class="form-control input-rounded" required>
                                    <option value="">Selecione o director de turma</option>
                                    <?php foreach ($Professors as $Professor): ?>
                                        <option value="<?= $Professor->getIdProfessor() ?>"><?= htmlspecialchars($Professor->getNomeProfessor()) ?></option>
                                    <?php endforeach; ?>
                            ...
                            <div class="text-center mt-4">
                                <a href="#" class="btn btn-light btn-rounded ml-2" data-bs-dismiss="modal">Cancelar</a>
                                <button type="submit" class="btn btn-primary btn-rounded" name="actualizarDocumentoAluno">Salvar Alterações</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modalDocumentoApagar">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Cancelar solicitação de documento</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <p>Tem certeza que deseja cancelar esta solicitação? Esta ação não pode ser desfeita.</p>
                        <form id="formDocumentoExcluir" method="POST" action="../Controle/crudDocumento.php">
                            <input type="hidden" name="idDocumento" id="idDocumentoApagar" required>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <a href="#" class="btn btn-light btn-rounded ml-2" data-bs-dismiss="modal">Cancelar</a>
                        <button type="submit" form="formDocumentoExcluir" class="btn btn-danger" name="apagarDocumentoAluno">Confirmar</button>
                    </div>
                </div>
            </div>
        </div>
